package com.aps.poccargasqlite.dialect;
...
public class SQLiteDialect extends Dialect {
    ...
    private static final ViolatedConstraintNameExtracter EXTRACTER = new TemplatedViolatedConstraintNameExtracter() {
        ...
        protected String doExtractConstraintName(SQLException sqle) throws NumberFormatException {
            int errorCode = JdbcExceptionHelper.extractErrorCode(sqle) & 0xFF;
  ...
  */
    ...
    private static class SQLiteUniqueDelegate extends DefaultUniqueDelegate {
        ...
        /**
         * SQLite uses table creation sql to define unique constraints, and do not support alter
         * table sql to add constraints. Such as "create table person( first_name
         * varchar(255),last_name varchar(255),unique(first_name, last_name) )".
         */
        @Override
